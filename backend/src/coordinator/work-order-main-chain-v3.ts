...
export function createWorkOrderMainChainV3(
  database: PGliteInterface,
  embedder: QueryEmbedder,
  dependencies: WorkOrderMainChainV3Dependencies,
): WorkOrderMainChainV3 {
  if (
    dependencies.sourceAwareAnswerabilityModel.promptVersion !==
    QWEN_ANSWERABILITY_PROMPT_VERSION_V8
  ) {
    throw new Error("formal work-order main chain v3 requires answerability v8");
  }
...
export function createWorkOrderMainChainV3FromEnvironment(
  database: PGliteInterface,
  embedder: QueryEmbedder,
